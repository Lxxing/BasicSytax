...
#ifndef _TAO_IDL_HELLOS_KRA9E0_CPP_
#define _TAO_IDL_HELLOS_KRA9E0_CPP_
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      ...
      {"",0,0},{"",0,0},{"",0,0},
      {"get_hello", &POA_Test::Hello::get_hello_skel, 0},
...
namespace POA_Test
{
  ...
  class get_hello_Hello
    : public TAO::Upcall_Command
  {
  public:
    inline get_hello_Hello (
...
void POA_Test::Hello::get_hello_skel (
