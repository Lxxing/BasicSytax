...
//<!***************************************************************************
void GetConsumerListByGroupResponseBody::Decode(const MQBuffer* mem, vector<string>& cids) {
  cids.clear();
  //<! decode;
...
void ResetOffsetRequestHeader::setTimeStamp(const MQINT64& tmp) {
  timestamp = tmp;
}
...
const MQINT64 ResetOffsetRequestHeader::getTimeStamp() const {
  return timestamp;
}
